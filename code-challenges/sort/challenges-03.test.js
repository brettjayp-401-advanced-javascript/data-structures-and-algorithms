...
const sortPeople = arr => arr.sort((a,b) => a.lastName > b.lastName ? 1
...
const sortPeopleBetter = arr => arr.sort((a,b) => a.lastName > b.lastName ? 1
  : (a.lastName < b.lastName) ? -1
...
const sortMeetingsByDay = arr => arr.sort((a,b) => days[a.dayOfWeek] > days[b.dayOfWeek] ? 1
  : (days[a.dayOfWeek] < days[b.dayOfWeek]) ? -1
  : 0
);
...
const sortSchedule = arr => arr.sort((a,b) => days[a.dayOfWeek] > days[b.dayOfWeek] ? 1 
  : (days[a.dayOfWeek] < days[b.dayOfWeek]) ? -1 
  : (a.start > b.start) ? 1
  : (a.start < b.start) ? -1
  : ((a.end - a.start) > (b.end - b.start)) ? 1
  : ((a.end - a.start) < (b.end - b.start)) ? -1
  : 0
);
